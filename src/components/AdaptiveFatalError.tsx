...
export function AdaptiveFatalError({
	...
	const isDark =
		theme === "dark" ||
		(typeof theme === "object" && theme?.backgroundColor === "dark")
	const primaryColor =
		typeof theme === "object" ? theme.primaryColor : undefined
	...
	return (
		<Dialog.Root open={isOpen} onOpenChange={onOpenChange}>
			<Dialog.Portal>
				<div
					className={`cognicatch-ui-wrapper ${isDark ? "dark" : ""} ${fontFamily || ""}`}
				>
					<Dialog.Overlay className="radix-overlay fixed inset-0 z-[99999] bg-zinc-900/20 dark:bg-black/80 backdrop-blur-sm" />

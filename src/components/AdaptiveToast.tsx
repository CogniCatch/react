    ...
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          title: cn("font-medium text-sm text-zinc-900 dark:text-zinc-50", toastOptions?.classNames?.title),
          description: cn("mt-0.5 text-xs text-zinc-500 dark:text-zinc-400 line-clamp-2", toastOptions?.classNames?.description),
          actionButton: cn(

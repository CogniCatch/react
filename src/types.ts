...
export const GenUIResponseSchema = z.object({
  ...
  title: z.string().describe("A short, user-friendly title for the error (max 5 words)."),
  ...
  actionLabel: z.string().nullable().describe("Short text for the recovery button (e.g., 'Try Again', 'Reload'). Max 3 words."),
});
